...
extern void *mono_aot_module_CsvHelper_info;
...
extern void *mono_aot_module_BKBToolClient_info;
...
void register_aot_modules (void)
{
    mono_aot_register_module (mono_aot_module_CsvHelper_info);
    ...
    mono_aot_register_module (mono_aot_module_BKBToolClient_info);
